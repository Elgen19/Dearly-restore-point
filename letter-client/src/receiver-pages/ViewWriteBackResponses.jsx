      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 py-4 h-full flex items-center justify-center">
        ...
        <AnimatePresence mode="wait">
          {selectedResponse ? (
              ...
              <div className="mb-4 flex-shrink-0">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-3 mb-3">
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    {/* Back button - visible on mobile inside card (consistent style) */}
                    {onBack && (
                      <motion.button
                        initial={{ opacity: 0, x: -20 }}
                        animate={{ opacity: 1, x: 0 }}
                        ...
                        className="md:hidden w-12 h-12 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center border border-white/20 shadow-lg transition-all group flex-shrink-0"
                        aria-label="Go back"
                      >
                        <svg
                          className="w-6 h-6 text-white group-hover:text-pink-300 transition-colors"
                    ...
                    <h2 className="text-xl md:text-2xl font-serif text-white flex-1 truncate">
                      Response to: {selectedResponse.letterTitle || 'Letter'}
                    </h2>
                  </div>
                  {/* Action buttons - stack nicely on mobile, inline on desktop */}
                  <div className="flex flex-wrap md:flex-nowrap items-center justify-end gap-2 w-full md:w-auto">
                    <button
                      ...
                      className="flex-1 md:flex-none min-w-[120px] md:min-w-0 bg-blue-500/80 hover:bg-blue-500 text-white font-serif px-3 md:px-4 py-2 rounded-lg transition-all flex items-center justify-center gap-2 text-xs md:text-sm"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 md:flex-none min-w-[120px] md:min-w-0 bg-red-500/80 hover:bg-red-500 text-white font-serif px-3 md:px-4 py-2 rounded-lg transition-all flex items-center justify-center gap-2 text-xs md:text-sm"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              {/* Header with inline back button on mobile */}
              <div className="mb-4 flex-shrink-0 flex items-center gap-3 md:gap-4">
                {onBack && (
                  <motion.button
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
                    ...
                    className="md:hidden w-10 h-10 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center border border-white/20 shadow-lg transition-all group flex-shrink-0"
                    aria-label="Go back"
                  >
                    <svg
