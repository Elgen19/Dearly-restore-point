// MainBodyPreviewSelector.jsx - Component to show main body previews and allow selection
import React, { useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
import MainBodyPreviewV1 from "./MainBodyPreviewV1";
import MainBodyPreviewV3 from "./MainBodyPreviewV3";

export default function MainBodyPreviewSelector({ 
  mainBody, 
  receiverName = "",
  userFirstName = "",
  onSelect
  ...
  const versions = [
    { id: 1, name: "Scroll Unravel", description: "Classic and elegant", component: MainBodyPreviewV1 },
    { id: 3, name: "Magic Envelope", description: "Enchanted and romantic", component: MainBodyPreviewV3 },
  ];
  
  const SelectedComponent = versions.find(v => v.id === selectedVersion)?.component || MainBodyPreviewV1;
