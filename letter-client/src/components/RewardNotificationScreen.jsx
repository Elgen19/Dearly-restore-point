// RewardNotificationScreen.jsx - Screen shown after claiming reward
import React from 'react';
import { motion } from 'framer-motion';

export default function RewardNotificationScreen({ reward, onClose }) {
  const rewardName = reward?.name || reward?.typeName || 'your reward';
    ...
    <div className="fixed inset-0 z-50 h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <motion.p
          ...
          className="text-lg md:text-xl font-serif text-pink-200 mb-4"
        >
          I've been notified that you completed the game and claimed your reward.
        </motion.p>
        ...
        >
          I'll arrange everything for you soon. Thank you for playing, and I can't wait to share this moment with you 💕
        </motion.p>
