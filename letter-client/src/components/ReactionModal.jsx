    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="bg-gradient-to-br from-purple-900/95 via-pink-900/95 to-rose-900/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-6 sm:p-8 max-w-lg w-full max-h-[90vh] overflow-y-auto">
              {/* Header */}
                  ...
                  <div className="grid grid-cols-4 gap-3">
                    {reactions.map((reaction) => (
                      <motion.button
                        ...
                        className={`p-4 rounded-xl font-serif text-sm transition-all ${
                      ...
                      >
                        ...
                        <div className="text-white text-xs">{reaction.label}</div>
                      </motion.button>
                    ))}
                  </div>
                </div>
              ...
              <div className="mb-4">
                <motion.button
                  ...
                  className={`w-full px-4 py-2 rounded-lg font-serif text-sm transition-all ${
                    useCustom
              ...
              <div className="flex justify-center">
                <motion.button
                  ...
                  className="w-full sm:w-auto px-8 py-2.5 bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white rounded-lg font-serif font-semibold text-sm shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
